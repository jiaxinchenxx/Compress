public class BinaryTree extends BinaryTreeBasis {
  ...
  public BinaryTree(CharFreq rootItem) {
    super(rootItem);
  }  // end constructor
  ...
  public void setRootItem(CharFreq newItem) {
    if (root != null) {
  ...
  public void attachLeft(CharFreq newItem) {
  ...
  public void attachRight(CharFreq newItem) {
